...
// timestamp. The msg must have at least one entry in its Question section;
// callers are responsible for validating msg before calling. If the
// Question section is empty the returned event will have an empty Qname,
// nil Qtype and nil Qclass, but other header-derived fields will still
// be populated.
